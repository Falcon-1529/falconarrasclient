...
// Simulate an HTTP redirect:
window.location.replace("https://i.kym-cdn.com/entries/icons/original/000/000/091/TrollFace.jpg");
    alert("Nice try lmao.");
...
~ function() {
    ...
    (function(r) {
      ...
      function e(b) {
        switch (b) {
          ...
          case 13:
            return l.gold;
          case 14:
            return "#768cfc"; //penta purple/indigo
          case 15:
            return "	#ee00ff"; //magenta
          case 16:
            return l.grey;
          case 17:
            return l.dgrey;
          ...
          case 40://polychrome spectrum starts here!
            return "#ff5900";//red-orange
          case 41:
          ...
          case 43:
            return "#fffb00";//yellow
             ...
             case 44:
            return "#fffb00";//green neon
             case 45:
            return "#00ff91";//teal
             case 46:
            return "#00ffee";//cyan
             case 47:
            return "#00bfff";//cerulean
             case 48:
            return "#0044ff";//blue
             case 49:
      ...
      function E(b) {
        let d = B.graphical.neon ? l.guiblack : l.guiblack;
        ...
        switch (b) {
          ...
          default:
            ...
            function t() {
                if (!ua) {
                    ...
                    switch (document.getElementById("optBorders").value) {
                      ...
                      case "noBorders":
                        B.graphical.darkBorders = B.graphical.neon = 0,B.graphical.noBorders = 1;
                        break;
                    }
            ...
            const Ra = (() => {
                ...
                if (z.name.includes("Falcon 1529", "Falcon-chan", "I came in Zelda's ass", "Fapcum-chan", "Zelda likes my milk", "Luftwaffe"))
                  N.draw(
                    z.name,
                    Math.round(c + 165) + 0.5,
                    Math.round(d - 10 - 4) + 0.5,
                    32,
                    150 > Date.now() % 300 ? l.guiwhite : l.blue,
                    "center"
                  );
                                g.lineWidth = 4;/*
                                if (//name color) {
                            ...
                            b.mobile && L(.8); {
                                ...
                                if (B.graphical.screenshotMode) W[6].draw("Falcon's Arras", h + 200, m - 2, 15, l.blue, "right");
                                else {
                                    if (b.showDebug) {
                                        W[6].draw("Falcon's Arras",
                                        ...
                                        W[4].draw("Prediction: " + d.toFixed(3), h + 200, m - 56, 10, l.green, "right");
                                        W[3].draw("Update Rate: " + J.updatetime + "Hz", h + 200, m - 42, 10, l.green, "right")
                                    } else W[6].draw("Falcon's Arras", h + 200, m - 42 - 2, 15, l.blue, "right");
                                    W[2].draw("Client Speed: " + J.rendertime + " FPS", h + 200, m - 28, 10, 10 < J.rendertime ? l.green : l.red, "right");
                                    W[1].draw("Server Speed: " + (100 * A.fps).toFixed(2) + "%", h + 200, m - 14, 10, 1 === A.fps ? l.green : l.red, "right");
                                    W[0].draw(v.toFixed(1) + " ms  " + b.server.code + " :" + b.server.type + ":", h + 200, m, 10, l.purple, "right")
                                }
                            }
                            b.mobile && L(1.25);
                            b.mobile && L(1.4);
                  ...
                  if (b.label.includes("Falcon 1529"))
                    ca[a].draw(
                      b.label + ": " + H.handleLargeNumber(Math.round(b.score)),
                      c + 100,
                      d + 7,
                      9,
                      150 > Date.now() % 300 ? l.red : l.green,
                      "center",
                      !0
                    );
                                  if (b.label.includes("Falcon-chan"))
                    ca[a].draw(
                      b.label + ": " + H.handleLargeNumber(Math.round(b.score)),
                      c + 100,
                      d + 7,
                      ...
                      !0
                                  ...
                                  if (b.label.includes("I came in Zelda's ass"))
                    ca[a].draw(
                      b.label + ": " + H.handleLargeNumber(Math.round(b.score)),
                      c + 100,
                      d + 7,
                    ...
                    ca[a].draw(
                      ...
                      !0
                                  ...
                                  if (b.label.includes("Zelda likes my milk"))
                    ca[a].draw(
                      b.label + ": " + H.handleLargeNumber(Math.round(b.score)),
                      c + 100,
                      d + 7,
                      ...
                      !0
                                   ...
                                   if (b.label.includes("Z-z-zelda I'm cumming!"))
                    ca[a].draw(
                      b.label + ": " + H.handleLargeNumber(Math.round(b.score)),
                      c + 100,
                      d + 7,
                      ...
                      !0
                                   ...
                                   if (b.label.includes("Zelda made me cum"))
                    ca[a].draw(
                      b.label + ": " + H.handleLargeNumber(Math.round(b.score)),
                      c + 100,
                      d + 7,
                ...
                Ta = (() => {
                    ...
                    return () => {
                        ...
                        a.draw("OMG YOU DIED BIG FUNNIE COMEDI!!!!!!!!!!!!!!!!", d, n - 80, 8, l.guiwhite, "center");
                        e.draw("Level " +
                        ...
                        h.draw("\u231a Endured for " + H.timeForHumans(Math.round(b.finalLifetime.get())), d - 170, n + 55, 16, l.guiwhite);
            ...
            const Sa = (() => {
                    ...
                    m();
                    var c = [
                        ["Tip: You can view and edit your keybinds in the options menu.", "Tip: You can play on mobile by just going to falcon-arras.netlify.app, falcon-arras.glitch.me or falcon-arras.surge.sh on your phone!"],
                        ["Tip: You can have the shield and health bar be separated by going to the options menu.",
                            "Tip: If arras is having a low frame rate, you can try enabling low graphics in the options menu.", "Tip: You can make traps rounded with the classic trap setting in the options menu.",
                        ],
                    ...
                    return () => {
                        F(l.white, .5);
                        a.draw("Thou shalt connecteth very soon...", b.screenWidth / 2, b.screenHeight / 2, 30, l.guiwhite, "center");
                ...
                Ua = (() => {
                    ...
                    return () => {
                        ...
                        a.draw("\ud83d\udc80 LMAO Fortnite FUNNIE XD MOMENT!!!!\ud83d\udc80", b.screenWidth / 2, b.screenHeight / 2, 30, l.guiwhite, "center");
